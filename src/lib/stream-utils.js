...
exports.convertWebToNodeStream = convertWebToNodeStream;
var stream_1 = require("stream");
var web_1 = require("stream/web");
function convertWebToNodeStream(webStream) {
    // Create a type-safe wrapper that properly handles the conversion
    var stream = new web_1.ReadableStream({
        start: function (controller) {
            return __awaiter(this, void 0, void 0, function () {
                var reader, _a, done, value, error_1;
